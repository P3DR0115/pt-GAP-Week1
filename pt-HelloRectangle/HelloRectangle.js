...
function main() {
    ...
    gl.drawArrays(gl.TRIANGLE_STRIP, 0, n);                         // Draws a rectanlge to the screen

    //gl.drawArrays(gl.TRIANGLE_FAN, 0, n);                         // Creates a ribbon-like shape          
...
function initVertexBuffers(gl) {                                    // Initializing the vertices for the triangle.
    ...
    var n = 4;                                                      // defines how many points to draw
